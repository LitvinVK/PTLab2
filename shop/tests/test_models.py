...
class ProductTestCase(TestCase):
    def setUp(self):
        ...
        Product.objects.create(name="pencil", price="50", count="10")
    ...
    def test_correctness_data(self):
        ...
        self.assertTrue(Product.objects.get(name="book").count == 5)
        self.assertTrue(Product.objects.get(name="pencil").count == 10)
